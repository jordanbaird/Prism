...
[![Continuous Integration](https://img.shields.io/github/actions/workflow/status/jordanbaird/Prism/build.yml?branch=main&style=flat-square)](https://github.com/jordanbaird/Prism/actions/workflows/build.yml)
...
```swift
.package(url: "https://github.com/jordanbaird/Prism", from: "0.1.1")
```
